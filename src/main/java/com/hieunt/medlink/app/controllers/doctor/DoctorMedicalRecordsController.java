...
public class DoctorMedicalRecordsController {
    ...
    public ResponseEntity<BaseResponse<Page<MedicalRecordsEntity>>> getMyDoctorMedicalRecords(
            @PageableDefault(size = 20) Pageable pageable) {
        return ResponseEntity.ok(medicalRecordsService.getMyDoctorMedicalRecords(pageable));
    }
    ...
    public ResponseEntity<BaseResponse<Page<MedicalRecordsResponse>>> filterMedicalRecords(
        ...
        BaseResponse<Page<MedicalRecordsResponse>> response = medicalRecordsService.filterMedicalRecords(
                hospitalId, patientId, null, status, keyword, pageable);
